<?php
/*
Plugin Name: Subhash Darksky Weather
Plugin URI: http://github.com/Subhash/SubhashDarkSkyWeather
Description: Reads the DarkSky REST API and Provides a shortcode and widget. Also does Google Reverse Goecoding.
Version: 1.0
Author: Subhash Rangapure
Author URI: http://github.com/Subhash/
Text Domain: Subhash-plugin
License: GPLv3
 */

register_activation_hook(__FILE__, 'Subhash_darksky_weather_install');

function Subhash_darksky_weather_install(){
    global $wp_version;
...
register_deactivation_hook(__FILE__, 'Subhash_darksky_weather_deactivate');

function Subhash_darksky_weather_deactivate(){
...
add_action( 'widgets_init', 'Subhash_darksky_weather_create_widgets' );

function Subhash_darksky_weather_create_widgets() {
	register_widget( 'Subhash_DarkySky_Weather' );
}
...
* @return string
*
* This is borrowed from: https://pippinsplugins.com/using-wp_remote_get-to-parse-json-from-remote-apis/
*/
function get_darksky_json_shortcode($atts, $content = null ) {


  //hard-coded URL
     $url = 'https://api.darksky.net/forecast/271b85932579150920b7d2719334db51/37.8267,-122.4233';
 ...
 //obtain JSON - as object or array
  ...
  $output .= '<br>';
     $output .= "temperature: " . $data['currently']['temperature'];
...
class Subhash_DarkySky_Weather extends WP_Widget {
	// Construction function
	function __construct () {
		parent::__construct( 'Subhash_DarkySky_Weather', 'DarkSky Weather',
			array( 'description' =>
